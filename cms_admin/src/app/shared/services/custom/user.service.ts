...
export class UserService extends BaseService {
    ...
    login(credentials: any, include: any = 'user', rememberMe: boolean = true): Observable<any> {
        let _method: string = "POST";
        let _url: string = ApiConfig.getPath() + "/" + ApiConfig.getApiVersion() +
            "/users/login";
        let _routeParams: any = {};
    ...
    public getCurrent(): any {
        let _method: string = "GET";
        let _url: string = ApiConfig.getPath() + "/" + ApiConfig.getApiVersion() + "/users" + "/:id";
    ...
    public isAdministrator() {
        ...
        if (this.isAuthenticated()) {
            ...
            let user: User = this.auth.getCurrentUserData();
            if (user && user.roles) {
    ...
    public getUserMedia(id: any, filter: LoopBackFilter = {}): Observable<any> {
        let _method: string = "GET";
        let _url: string = ApiConfig.getPath() + "/" + ApiConfig.getApiVersion() +
            "/users/:id/media";
        let _routeParams: any = {
    ...
    public updateAvatar(id: any, data: any): Observable<any> {
        let _method: string = "POST";
        let _url: string = ApiConfig.getPath() + "/" + ApiConfig.getApiVersion() +
            "/users/:id/avatar";
        let _routeParams: any = {
